Shader "EyedentityGames/ProjectM/DiffuseEmissiveCustomColor" {
Properties {
 _MainTex ("Base (RGB)", 2D) = "white" {}
 _MaskTex ("Mask (RGB)", 2D) = "white" {}
 _EmissivePower ("Emissive Power", Range(0,5)) = 2
...
uniform highp vec4 _CustomColor1;
uniform highp vec4 _CustomColor2;
varying highp vec2 xlv_TEXCOORD0;
varying lowp vec3 xlv_TEXCOORD1;
varying lowp vec3 xlv_TEXCOORD2;
void main ()
{
  ...
  highp vec3 tmpvar_6;
  tmpvar_6 = mix (c_1.xyz, (_CustomColor1.xyz * c_1.xyz), tmpvar_5.yyy);
  color_4.xyz = tmpvar_6;
  highp vec3 tmpvar_7;
  tmpvar_7 = mix (color_4.xyz, (_CustomColor2.xyz * color_4.xyz), tmpvar_5.zzz);
  color_4.xyz = tmpvar_7;
  highp vec3 tmpvar_8;
  tmpvar_8 = mix (color_4.xyz, (_EmissiveColor.xyz * _EmissivePower), tmpvar_5.xxx);
  color_4.xyz = tmpvar_8;
  c_1 = color_4;
...
void main ()
{
  ...
  highp vec3 tmpvar_5;
  tmpvar_5 = mix (c_1.xyz, (_CustomColor1.xyz * c_1.xyz), tmpvar_4.yyy);
  color_3.xyz = tmpvar_5;
  highp vec3 tmpvar_6;
  tmpvar_6 = mix (color_3.xyz, (_CustomColor2.xyz * color_3.xyz), tmpvar_4.zzz);
  color_3.xyz = tmpvar_6;
  highp vec3 tmpvar_7;
  tmpvar_7 = mix (color_3.xyz, (_EmissiveColor.xyz * _EmissivePower), tmpvar_4.xxx);
  color_3.xyz = tmpvar_7;
  c_1 = color_3;
...
void main ()
{
  ...
  highp vec3 tmpvar_8;
  tmpvar_8 = mix (c_1.xyz, (_CustomColor1.xyz * c_1.xyz), tmpvar_7.yyy);
  color_6.xyz = tmpvar_8;
  highp vec3 tmpvar_9;
  tmpvar_9 = mix (color_6.xyz, (_CustomColor2.xyz * color_6.xyz), tmpvar_7.zzz);
  color_6.xyz = tmpvar_9;
  highp vec3 tmpvar_10;
  tmpvar_10 = mix (color_6.xyz, (_EmissiveColor.xyz * _EmissivePower), tmpvar_7.xxx);
  color_6.xyz = tmpvar_10;
  c_1 = color_6;
...
void main ()
{
  ...
  color_6.w = c_1.w;
  lowp vec4 tmpvar_7;
  tmpvar_7 = texture (_MaskTex, xlv_TEXCOORD0);
  highp vec3 tmpvar_8;
  tmpvar_8 = mix (c_1.xyz, (_CustomColor1.xyz * c_1.xyz), tmpvar_7.yyy);
  color_6.xyz = tmpvar_8;
  highp vec3 tmpvar_9;
...
void main ()
{
  ...
  tmpvar_12 = mix (c_1.xyz, (_CustomColor1.xyz * c_1.xyz), tmpvar_11.yyy);
  color_10.xyz = tmpvar_12;
  highp vec3 tmpvar_13;
  tmpvar_13 = mix (color_10.xyz, (_CustomColor2.xyz * color_10.xyz), tmpvar_11.zzz);
  color_10.xyz = tmpvar_13;
  highp vec3 tmpvar_14;
  tmpvar_14 = mix (color_10.xyz, (_EmissiveColor.xyz * _EmissivePower), tmpvar_11.xxx);
  color_10.xyz = tmpvar_14;
  c_1 = color_10;
...
void main ()
{
  ...
  color_9.w = c_1.w;
  lowp vec4 tmpvar_10;
  tmpvar_10 = texture2D (_MaskTex, xlv_TEXCOORD0);
  highp vec3 tmpvar_11;
  tmpvar_11 = mix (c_1.xyz, (_CustomColor1.xyz * c_1.xyz), tmpvar_10.yyy);
  color_9.xyz = tmpvar_11;
  highp vec3 tmpvar_12;
  tmpvar_12 = mix (color_9.xyz, (_CustomColor2.xyz * color_9.xyz), tmpvar_10.zzz);
  color_9.xyz = tmpvar_12;
  highp vec3 tmpvar_13;
  tmpvar_13 = mix (color_9.xyz, (_EmissiveColor.xyz * _EmissivePower), tmpvar_10.xxx);
  color_9.xyz = tmpvar_13;
  c_1 = color_9;
...
void main ()
{
  ...
  color_13.w = c_1.w;
  lowp vec4 tmpvar_14;
  tmpvar_14 = texture2D (_MaskTex, xlv_TEXCOORD0);
  highp vec3 tmpvar_15;
  tmpvar_15 = mix (c_1.xyz, (_CustomColor1.xyz * c_1.xyz), tmpvar_14.yyy);
  color_13.xyz = tmpvar_15;
  highp vec3 tmpvar_16;
  tmpvar_16 = mix (color_13.xyz, (_CustomColor2.xyz * color_13.xyz), tmpvar_14.zzz);
  color_13.xyz = tmpvar_16;
  highp vec3 tmpvar_17;
  tmpvar_17 = mix (color_13.xyz, (_EmissiveColor.xyz * _EmissivePower), tmpvar_14.xxx);
  color_13.xyz = tmpvar_17;
  c_1 = color_13;
...
void main ()
{
  ...
  color_13.w = c_1.w;
  lowp vec4 tmpvar_14;
  tmpvar_14 = texture (_MaskTex, xlv_TEXCOORD0);
  highp vec3 tmpvar_15;
  tmpvar_15 = mix (c_1.xyz, (_CustomColor1.xyz * c_1.xyz), tmpvar_14.yyy);
  color_13.xyz = tmpvar_15;
  highp vec3 tmpvar_16;
...
void main ()
{
  ...
  highp vec3 tmpvar_9;
  tmpvar_9 = mix (c_1.xyz, (_CustomColor1.xyz * c_1.xyz), tmpvar_8.yyy);
  color_7.xyz = tmpvar_9;
  highp vec3 tmpvar_10;
  tmpvar_10 = mix (color_7.xyz, (_CustomColor2.xyz * color_7.xyz), tmpvar_8.zzz);
  color_7.xyz = tmpvar_10;
  highp vec3 tmpvar_11;
  tmpvar_11 = mix (color_7.xyz, (_EmissiveColor.xyz * _EmissivePower), tmpvar_8.xxx);
  color_7.xyz = tmpvar_11;
  c_1 = color_7;
...
void main ()
{
  ...
  tmpvar_11 = texture2D (_MaskTex, xlv_TEXCOORD0);
  highp vec3 tmpvar_12;
  tmpvar_12 = mix (color_10.xyz, (_CustomColor1.xyz * color_10.xyz), tmpvar_11.yyy);
  color_10.xyz = tmpvar_12;
  highp vec3 tmpvar_13;
  tmpvar_13 = mix (color_10.xyz, (_CustomColor2.xyz * color_10.xyz), tmpvar_11.zzz);
  color_10.xyz = tmpvar_13;
...
void main ()
{
  ...
  color_15 = c_2;
  lowp vec4 tmpvar_16;
  tmpvar_16 = texture2D (_MaskTex, xlv_TEXCOORD0);
  highp vec3 tmpvar_17;
  tmpvar_17 = mix (color_15.xyz, (_CustomColor1.xyz * color_15.xyz), tmpvar_16.yyy);
  color_15.xyz = tmpvar_17;
  highp vec3 tmpvar_18;
  tmpvar_18 = mix (color_15.xyz, (_CustomColor2.xyz * color_15.xyz), tmpvar_16.zzz);
  color_15.xyz = tmpvar_18;
  highp vec3 tmpvar_19;
  tmpvar_19 = mix (color_15.xyz, (_EmissiveColor.xyz * _EmissivePower), tmpvar_16.xxx);
  color_15.xyz = tmpvar_19;
  c_2 = color_15;
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
void main ()
{
  ...
  color_15 = c_2;
  lowp vec4 tmpvar_16;
  tmpvar_16 = texture (_MaskTex, xlv_TEXCOORD0);
  highp vec3 tmpvar_17;
  tmpvar_17 = mix (color_15.xyz, (_CustomColor1.xyz * color_15.xyz), tmpvar_16.yyy);
  color_15.xyz = tmpvar_17;
  highp vec3 tmpvar_18;
...
void main ()
{
  ...
  highp vec3 tmpvar_14;
  tmpvar_14 = mix (color_12.xyz, (_CustomColor1.xyz * color_12.xyz), tmpvar_13.yyy);
  color_12.xyz = tmpvar_14;
  highp vec3 tmpvar_15;
  tmpvar_15 = mix (color_12.xyz, (_CustomColor2.xyz * color_12.xyz), tmpvar_13.zzz);
  color_12.xyz = tmpvar_15;
  highp vec3 tmpvar_16;
  tmpvar_16 = mix (color_12.xyz, (_EmissiveColor.xyz * _EmissivePower), tmpvar_13.xxx);
  color_12.xyz = tmpvar_16;
  c_2 = color_12;
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
}
...
void main ()
{
  ...
  color_12 = c_2;
  lowp vec4 tmpvar_13;
  tmpvar_13 = texture (_MaskTex, xlv_TEXCOORD0);
  highp vec3 tmpvar_14;
  tmpvar_14 = mix (color_12.xyz, (_CustomColor1.xyz * color_12.xyz), tmpvar_13.yyy);
  color_12.xyz = tmpvar_14;
  highp vec3 tmpvar_15;
